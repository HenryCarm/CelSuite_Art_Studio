...
class CelStudioWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("CelSuite Art Studio v269.2.0 (Liquid Glass Yellow Edition) 🎨✨")
    ...
    def load_settings(self):
        ...
        return {
            ...
            "dolphin_path": "",
            "lora_path": "",
            "pos_prompt": "1cat, cute",
            "sticky_prompt": "masterpiece, best quality, ultra-detailed, highres, 8k resolution, cinematic lighting",
...
def main():
    ...
    app.setApplicationVersion("269.2.0")
